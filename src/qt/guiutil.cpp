...
{
    if(uri.scheme() != QString("CryptoShares"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("CryptoShares://"))
    {
        uri.replace(0, 11, "CryptoShares:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("CryptoShares-qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  CryptoShares-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("CryptoShares-qt"));
